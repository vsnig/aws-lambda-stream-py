    ...
    return rx.pipe(
      ...
      opt["publish"](
        **opt,
        ...
        batch_size=int(os.getenv("FAULTS_BATCH_SIZE") or 0) or int(os.getenv("BATCH_SIZE") or 0) or 4,
        parallel=int(os.getenv("FAULTS_PARALLEL") or 0) or int(os.getenv("PARALLEL") or 0) or 4,
        )
    )(s)
